...
class TcpChatSessionBase : public net::TcpSessionBase<Derived, ArgsType>,
 ...
 public:
  ...
  explicit TcpChatSessionBase(ChatRoom &room, net::IoHandle &io_handle,
                              net::SessionMgr<Derived> &session_mgr,
...
class TcpChatSession
    : public TcpChatSessionBase<TcpChatSession, net::TemplateArgsTcpSession> {
 public:
  using TcpChatSessionBase<TcpChatSession,
                           net::TemplateArgsTcpSession>::TcpChatSessionBase;
};
