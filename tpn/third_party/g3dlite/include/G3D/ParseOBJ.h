...
public:
    ...
    void parse(const char* ptr, size_t len, const String& basePath, const ArticulatedModel::Specification::OBJOptions& options);

    void parse(BinaryInput& bi, const ArticulatedModel::Specification::OBJOptions& options = ArticulatedModel::Specification::OBJOptions(), const String& basePath = "<AUTO>");
};
