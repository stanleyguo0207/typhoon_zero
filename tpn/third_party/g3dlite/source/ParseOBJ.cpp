...
void ParseOBJ::parse(const char* ptr, size_t len, const String& basePath, const ArticulatedModel::Specification::OBJOptions& options) {
    vertexArray.clear();
    normalArray.clear();
    ...
    bool hasTexCoord1 = m_objOptions.texCoord1Mode == ArticulatedModel::Specification::OBJOptions::UNPACK_FROM_TEXCOORD0_Z || 
                        m_objOptions.texCoord1Mode == ArticulatedModel::Specification::OBJOptions::TEXCOORD0_ZW; 
    if ( hasTexCoord1 ) {
...
void ParseOBJ::parse(BinaryInput& bi, const ArticulatedModel::Specification::OBJOptions& options, const String& basePath) {
