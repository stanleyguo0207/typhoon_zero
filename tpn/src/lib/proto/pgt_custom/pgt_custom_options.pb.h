...
#ifndef GOOGLE_PROTOBUF_INCLUDED_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto
...
struct TableStruct_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto;
namespace tpn {
namespace protocol {
...
class TPNServiceOptions final :
 ...
 public:
  ...
  enum : int {
    ...
    kInboundFieldNumber = 2,
    kOutboundFieldNumber = 3,
  };
 ...
 private:
  ...
  friend struct ::TableStruct_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto;
};
// -------------------------------------------------------------------
...
// bool inbound = 2;
inline void TPNServiceOptions::clear_inbound() {
  inbound_ = false;
}
inline bool TPNServiceOptions::_internal_inbound() const {
  return inbound_;
}
inline bool TPNServiceOptions::inbound() const {
  // @@protoc_insertion_point(field_get:tpn.protocol.TPNServiceOptions.inbound)
  return _internal_inbound();
}
inline void TPNServiceOptions::_internal_set_inbound(bool value) {
  
  inbound_ = value;
}
inline void TPNServiceOptions::set_inbound(bool value) {
  _internal_set_inbound(value);
  // @@protoc_insertion_point(field_set:tpn.protocol.TPNServiceOptions.inbound)
}

// bool outbound = 3;
inline void TPNServiceOptions::clear_outbound() {
  outbound_ = false;
}
inline bool TPNServiceOptions::_internal_outbound() const {
  return outbound_;
}
inline bool TPNServiceOptions::outbound() const {
  // @@protoc_insertion_point(field_get:tpn.protocol.TPNServiceOptions.outbound)
  return _internal_outbound();
}
inline void TPNServiceOptions::_internal_set_outbound(bool value) {
  
  outbound_ = value;
}
inline void TPNServiceOptions::set_outbound(bool value) {
  _internal_set_outbound(value);
  // @@protoc_insertion_point(field_set:tpn.protocol.TPNServiceOptions.outbound)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_pgt_5fcustom_2fpgt_5fcustom_5foptions_2eproto
