...
template <> struct is_proto_enum< ::tpn::protocol::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tpn::protocol::ErrorCode>() {
  return ::tpn::protocol::ErrorCode_descriptor();
}
